...
function copy(parameter1, parameter2) {
...
function filterByWord(originalFlavors, filterFlavors) {
  for (let i = 0; i < originalFlavors.includes(filterFlavors); i++) {
    if (originalFlavors[i] == filterFlavors[i]);
  }
  {
    filterFlavors.push(originalFlavors[i]);
  }
}
